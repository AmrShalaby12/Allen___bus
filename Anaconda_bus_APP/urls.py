...
from .views import mark_attendance_university_code
from .views import update_payment_status
...
urlpatterns = [
    ...
    path('update-payment-status/<int:booking_id>/', update_payment_status, name='update_payment_status'),
    ...
    path('mark_attendance_university_code/', mark_attendance_university_code, name='mark_attendance_university_code'),
    # (ogin'),/', views.attendance_view, name='attendance'),

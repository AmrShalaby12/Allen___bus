...
CSRF_TRUSTED_ORIGINS = ['https://Alenbus.exploremelon.com']  # السماح بالمصدر الموثوق
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',  # محرك PostgreSQL
        'NAME': 'Allen_bus',                       # اسم قاعدة البيانات
        'USER': 'postgres',                        # اسم المستخدم
        'PASSWORD': 'Fomcy0-hugdit-rihbej',        # كلمة المرور
        'HOST': 'localhost',                       # الخادم (افتراضيًا localhost)
...
LOGIN_URL = '/login/'  # URL صفحة تسجيل الدخول
